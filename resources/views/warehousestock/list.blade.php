                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Warehouse Stock</h3>
                            <ul class="breadcrumb">
                                    ...
                                    <tbody>
                                        @foreach ($requisitions as $key => $requisition)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $allDelivered = $requisition->items->every(function($item) {
                                                ...
                                                <td>
                                                    <a href="{{ route('warehouse.stock.view', ['id' => $requisition->id]) }}"
                                                    ...
                                                    @if (!$allDelivered)
                                                        <a href="{{ route('warehouse.stock.delivery', ['id' => $requisition->id]) }}"
                                                        class="btn btn-sm btn-success">Delivery</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
