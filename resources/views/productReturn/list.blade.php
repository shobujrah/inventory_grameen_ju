                        ...
                        <div class="card-body">
                                        ...
                                        @foreach ($returnproducts as $key => $returnproduct)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($returnproduct->status == 0 && $returnproduct->deny_status == null && $showButton && auth()->user()->role_name !== 'Admin')
                                                        <a href="{{ route('cancel.returnproduct', $returnproduct->id) }}" class="btn btn-danger btn-sm" style="margin-top: 5px;">Cancel</a>
                                                    @endif

                                                    @if((auth()->user()->branch->type === 'Warehouse' || auth()->user()->role_name === 'Admin') && $returnproduct->status != 1 && $returnproduct->status != null)
                                                        <!-- <a href="{{ route('accept.returnproduct', $returnproduct->id) }}" class="btn btn-success btn-sm" style="margin-top: 5px;">Accept</a> --> 
                                                        ...
                                                        <div class="modal fade" id="acceptModal{{ $returnproduct->id }}" tabindex="-1" aria-labelledby="acceptModalLabel{{ $returnproduct->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <form action="{{ route('accept.returnproduct', $returnproduct->id) }}" method="POST">
                                                                    @csrf
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="denyModal" tabindex="-1" role="dialog" aria-labelledby="denyModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form id="denyForm" method="POST" action="{{ route('deny.returnproduct') }}">
                                            @csrf
