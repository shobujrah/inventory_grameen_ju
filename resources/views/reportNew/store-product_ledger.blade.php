                    ...
                    <div class="" id="multiCollapseExample1">
                        <div class="card">
                            <div class="card-body"> 
                                ...
                                <!-- <form method="GET" action="{{ route('report.store.product.ledger') }}">
                                    <div class="row justify-content-end">  
                                        ...
                                        <div class="col-md-2" style="margin-top: 30px;">
                                            ...
                                            <a href="{{ route('report.store.product.ledger') }}" class="btn btn-danger">
                                    ...
                                    <table class="table table-bordered table-center result-table">
                                        <thead class="warehouse-thread">
                                            <tr>
                                                ...
                                                <th class="text-center">This month<br>sales quantity</th>
                                                <th class="text-center">This month<br>sales price</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($groupedProducts as $categoryName => $products)
                                                ...
                                                @foreach($products as $productnamepirce)
                                                    ...
                                                    <tr>
                                                        <td>{{ $sl++ }}</td>
                                                        <td>{{ $productnamepirce->product->name ?? 'N/A' }}</td>
