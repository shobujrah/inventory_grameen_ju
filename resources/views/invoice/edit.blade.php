        ...
        <div class="content container-fluid">
                    ...
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('proposal.index') }}">Invoice</a></li>
            ...
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="fas fa-trash-alt text-danger repeater-action-btn ms-2  delete_item" data-repeater-delete></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td><strong>Sub Total ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td><strong>Discount ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td><strong>Tax ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td class="blue-text"><strong>Total Amount ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                ...
                <div class="modal-footer">
                    <input type="button" value="Cancel" onclick="location.href = '{{route("invoice.index")}}';" class="btn btn-light me-3">
