                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Journal Entry Create</h3>
                            <ul class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{\App\Models\Utility::journalNumberFormat($journalId)}}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="item-section py-4">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                                    <a  data-repeater-create="" class="btn btn-primary me-4" data-toggle="modal" data-target="#add-bank">
                                ...
                                <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                                    ...
                                    <tr>
                                        <td width="25%" class="form-group">
                                            {{ Form::select('account', $accounts,'', array('class' => 'form-control select2 js-searchBox ','required'=>'required')) }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="#" class="fas fa-trash-alt text-danger repeater-action-btn ms-2 bs-pass-para" data-repeater-delete></a>
                                        </td>
                                    </tr>
                                    </tbody>
                                    <tfoot>
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td class="text-end"><strong>{{__('Total Credit')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td class="text-end"><strong>{{__('Total Debit')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
