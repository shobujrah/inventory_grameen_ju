                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Journal Entry Edit</h3>
                            <ul class="breadcrumb">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <input type="text" class="form-control" value="{{\App\Models\Utility::journalNumberFormat($journalEntry->journal_id)}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4">
