                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($requisitionlist as $key => $requisition)
                                            <tr>
                                                ...
                                                <td class="text-center"><strong>{{ $warehouseStock[$requisition->product_id] ?? 'N/A' }}</strong></td>
                                                <!-- <td class="text-center"><strong>{{ $requisition->delivery }}</strong></td> -->
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @elseif ($requisition->delivery == 0 && $requisition->purchase == 0)
                                                        <span class="badge" style="background-color: #ffc107; color: #fff; padding: 0.25em 0.5em; border-radius: 0.25rem; font-weight: 600;">
                                                            Pending
                                                        </span>
                                                    @endif
