            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Edit Requisition</h3>
                        <ul class="breadcrumb">
        ...
        <div class="content container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form id="requisitionForm" action="{{ route('requisition.update', $requisitionheading->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            ...
                            <!-- <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="project_name" required name="project_name" value="{{ $requisitionheading->project_name }}" placeholder="Project Name">
                            </div> -->
                            ...
                            <!-- <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="date_from" required name="date_from" value="{{ $requisitionheading->date_from }}" placeholder="Date">
                            </div> -->
