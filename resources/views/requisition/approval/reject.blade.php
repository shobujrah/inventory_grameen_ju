                                    ...
                                    <tbody>
                                        @foreach ($requisitions as $key => $requisition)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($requisition->headoffice_reject == '1')
                                                ...
                                                <td>
                                                    <a href="{{ route('pending.approval.reject.list.view', $requisition->id) }}" class="btn btn-sm align-items-center" data-bs-toggle="tooltip" title="{{ __('View') }}">
                                                        <i class="fas fa-eye"></i>
                                                    </a>

                                                    <a href="#" class="btn btn-sm align-items-center" data-bs-toggle="modal" data-bs-target="#rejectNoteModal{{ $requisition->id }}" title="Reject">
                                                            <i class="fas fa-ban text-danger"></i>
                                                        </a>
                                                   
                                                         <!-- Reject Note Modal -->
                                                        <div class="modal fade" id="rejectNoteModal{{ $requisition->id }}" tabindex="-1" aria-labelledby="rejectNoteLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <!-- <textarea class="form-control" readonly>{{ $requisition->reject_note }}</textarea> -->
                                                                        <textarea class="form-control" readonly style="max-height: 200px; overflow-y: auto;">{{ $requisition->headoffice_reject_note }}</textarea>
                                                                    </div>
