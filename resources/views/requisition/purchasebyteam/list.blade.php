                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">purchase List By purchase team</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active"><a >purchase list</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($requisitionkey->purchase_approve == 1)
                                                         ...
                                                         <span style="background-color: #28A745; color: #FFF; padding: 0.25em 0.5em; border-radius: 0.25rem; font-weight: 600;">Purchased By PurchaseTeam</span>
                                                ...
                                                <td>
                                                    <a href="{{ route('purchase.list.view', $requisitionkey->id) }}"
