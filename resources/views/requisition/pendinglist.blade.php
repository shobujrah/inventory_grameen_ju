                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Pending Requisitions List</h3>
                            <ul class="breadcrumb">
                                    ...
                                    <tbody>
                                        @foreach ($requisitions as $key => $requisition)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('requisition.pending-list.view', $requisition->id) }}"
                                                        ...
                                                        <a href="{{ route('requisition.pending-list.instock', $requisition->id) }}"
