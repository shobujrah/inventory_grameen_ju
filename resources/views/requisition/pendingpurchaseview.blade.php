...
<script>
    function saveAsPDF() {
        ...
        var filename = "Purchase Requisition-" + formattedDate + ".pdf";
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Pending Purchase Requisitions View</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Pending Purchase Requisition</li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        @foreach ($requisitionlist as $key => $requisition)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($requisition->headoffice_approval == NULL)

                                                        <span class="badge" style="background-color: #ffc107; color: #fff; padding: 0.25em 0.5em; border-radius: 0.25rem; font-weight: 600;">
                                                            Pending
                                                        </span>

                                                    @elseif ($requisition->headoffice_approval == 1)
                                                        <span class="badge" style="background-color: #ffc107; color: #fff; padding: 0.25em 0.5em; border-radius: 0.25rem; font-weight: 600;">
                                                            Pending for Approval
                                                        </span>
                                                    @elseif ($requisition->headoffice_approval == 0)
                                                        <span class="badge" style="background-color: #28a745; color: #fff; padding: 0.25em 0.5em; border-radius: 0.25rem; font-weight: 600;">
                                                            Approved
                                                        </span>
                                                    @elseif ($requisition->headoffice_rejected == 1)
                                                        <span class="badge" style="background-color: #FF6347; color: #000; padding: 0.25em 0.5em; border-radius: 0.25rem; font-weight: 600;">
                                                            Reject
                                                        </span>
                                                    @endif
