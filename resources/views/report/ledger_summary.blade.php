                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col">
                            <div class="card p-4 mb-4">
                                ...
                                <h7 class="text-sm mb-0">{{ \App\Models\Utility::priceFormat($filter['debit']) }}</h7>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card p-4 mb-4">
                                <h6 class="mb-0">{{ __('Total Credit') }} :</h6>
                                <h7 class="text-sm mb-0">{{ \App\Models\Utility::priceFormat($filter['credit']) }}</h7>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card p-4 mb-4">
                                ...
                                <h7 class="text-sm mb-0">
                                    {{ $filter['balance'] > 0 ? __('Cr') . '. ' . \App\Models\Utility::priceFormat(abs($filter['balance'])) : __('Dr') . '. ' . \App\Models\Utility::priceFormat(abs($filter['balance'])) }}
                                </h7>
                            </div>
                        </div>
                    </div>
                                                ...
                                                @foreach ($account[0] as $a)
                                                        ...
                                                        @if ($account['invoice'] != [])
                                                            <tr>
                                                                ...
                                                                @php
                                                                    ...
                                                                    $totalCredit += $total;
                                                                @endphp
                                                                <td>{{ \App\Models\Utility::priceFormat($total) }}</td>
                                                    ...
                                                    @foreach ($account['invoicepayment'] as $invoicePaymentData)
                                                        <tr>
                                                            ...
                                                            <td>{{ \App\Models\Utility::priceFormat($invoicePaymentData->amount) }}</td>
                                                            <td>-</td>
                                                            @php
                                                    ...
                                                    @foreach ($account['revenue'] as $revenueData)
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td>{{ \App\Models\Utility::priceFormat($revenueData->amount) }}</td>
                                                            @php
                                                    ...
                                                    @foreach ($account['bill'] as $billProduct)
                                                        <tr>
                                                            ...
                                                            <td>{{ \App\Models\Utility::billNumberFormat($bill->bill_id) }}</td>
                                                    ...
                                                    @foreach ($account['billdata'] as $billData)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ \App\Models\Utility::priceFormat($billData->price) }}</td>
                                                            <td>-</td>
                                                            @php
                                                    ...
                                                    @foreach ($account['billpayment'] as $billPaymentData)
                                                        @if ($account['billpayment'] != [])
                                                            ...
                                                            <tr>
                                                                <td>{{ $accountName->name }}</td>
                                                                <!-- <td>{{ !empty($vendor) ? $vendor->name : '-' }}</td> -->
                                                                <td>{{ \App\Models\Utility::billNumberFormat($billId->bill_id) }}{{ __(' Manually Payment') }}
                                                                </td>
                                                                <td>{{ $billPaymentData->created_at->format('d-m-Y') }}</td>
                                                                <td>{{ \App\Models\Utility::priceFormat($billPaymentData->amount) }}</td>
                                                                <td>-</td>
                                                                @php
                                                    ...
                                                    @foreach ($account['payment'] as $paymentData)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ \App\Models\Utility::priceFormat($paymentData->amount) }}</td>
                                                            <td>-</td>
                                                            @php
                                                    ...
                                                    @foreach ($account['journalItem'] as $journalItemData)
                                                        <tr>
                                                            <td>{{ $accountName->name }}</td>
                                                            <!-- <td>{{ '-' }}</td> -->
                                                            <td>{{ App\Models\Utility::journalNumberFormat($journalItemData->journal_id) }}
                                                            </td>
                                                            <td>{{ $journalItemData->created_at->format('d-m-Y') }}</td>
                                                            @if ($journalItemData->debit == 0)
                                                                <td>{{ '-' }}</td>
                                                            @else
                                                                <td>{{ App\Models\Utility::priceFormat($journalItemData->debit) }}</td>
                                                            @endif
                                                            @if ($journalItemData->credit == 0)
                                                                <td> {{ '-' }}</td>
                                                            @else
                                                                <td>{{ \App\Models\Utility::priceFormat($journalItemData->credit) }}</td>
                                                            @endif
                                                            <td>
                                                                ...
                                                                @endif
                                                                {{ \App\Models\Utility::priceFormat($balance) }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @endforeach
