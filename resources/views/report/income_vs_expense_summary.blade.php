            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Income Vs Expense Summary</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Income Vs Expense Summary</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    @foreach($revenueIncomeTotal as $revenue)
                                        <td>{{\App\Models\Utility::priceFormat($revenue)}}</td>
                                    @endforeach
                                </tr>
                                <tr>
                                    <td>{{(__('Invoice'))}}</td>
                                    @foreach($invoiceIncomeTotal as $invoice)
                                        <td>{{\App\Models\Utility::priceFormat($invoice)}}</td>
                                    @endforeach
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    @foreach($paymentExpenseTotal as $payment)
                                        <td>{{\App\Models\Utility::priceFormat($payment)}}</td>
                                    @endforeach
                                </tr>
                                <tr>
                                    <td>{{(__('Bill'))}}</td>
                                    @foreach($billExpenseTotal as $bill)
                                        <td>{{\App\Models\Utility::priceFormat($bill)}}</td>
                                    @endforeach
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    @foreach($profit as $prft)
                                        <td>{{\App\Models\Utility::priceFormat($prft)}}</td>
                                    @endforeach
                                </tr>
                                </tbody>
                            </table>
