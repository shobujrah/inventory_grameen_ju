                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($resultArray as $receivableCustomer)
                                                    <tr>
                                                        ...
                                                        <td> {{ !empty($receivableCustomer['credit_price']) ? \App\Models\Utility::priceFormat($receivableCustomer['credit_price']) : \Auth::user()->priceFormat(0) }}
                                                        </td>
                                                        <td class="text-end">
                                                            {{ \App\Models\Utility::priceFormat($balance) }} </td>
                                                    </tr>
                                                @endforeach
                                                @if ($receivableCustomers != [])
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <th class="text-end">{{ \App\Models\Utility::priceFormat($total) }}
                                                        </th>
                                                    </tr>
                                                @endif
                                            </tbody>
                                        ...
                                        <table class="table table-flush" id="report-dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($agingSummaries as $key => $agingSummary)
                                                    <tr>
                                                        <td> {{ $key }}</td>
                                                        <td>{{ \App\Models\Utility::priceFormat($agingSummary['current']) }}
                                                        </td>
                                                        <td>{{ \App\Models\Utility::priceFormat($agingSummary['1_15_days']) }}
                                                        </td>
                                                        <td>{{ \App\Models\Utility::priceFormat($agingSummary['16_30_days']) }}
                                                        </td>
                                                        <td>{{ \App\Models\Utility::priceFormat($agingSummary['31_45_days']) }}
                                                        </td>
                                                        <td>{{ \App\Models\Utility::priceFormat($agingSummary['greater_than_45_days']) }}
                                                        </td>
                                                        <td>{{ \App\Models\Utility::priceFormat($agingSummary['total_due']) }}
                                                        </td>
                                                    </tr>
