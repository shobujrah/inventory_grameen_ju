            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Balance Summary</h3>
                        <ul class="breadcrumb">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="account-main-title mb-5">
                            <h5>{{ 'Balance Sheet of ' . ' as of ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange'] }}
                                </h4>
                        </div>
                        <div
                            ...
                            @if ($accounts != [])
                                <div class="account-main-inner py-2">
                                        ...
                                        <div class="border-bottom py-2">
                                            ...
                                            <div
                                                ...
                                                <p class="fw-bold mb-2 text-end">
                                                    {{ end($account['account']) == true ? \App\Models\Utility::priceFormat(end($account['account'])['netAmount']) : \App\Models\Utility::priceFormat(0) }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <h6 class="fw-bold mb-0 text-end">{{ \App\Models\Utility::priceFormat($total) }}</h6>
                                    </div>
                                    @php
                                        if ($type != 'Assets') {
                                            $totalAmount += $total;
                        ...
                        @foreach ($chartAccounts as $type => $accounts)
                            ...
                            @if ($accounts != [])
                                <div
                                    ...
                                    <h6 class="fw-bold mb-0 text-end">{{ \App\Models\Utility::priceFormat($totalAmount) }}</h6>
                                </div>
                            @endif
                            @php
