            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Receivable Reports</h3>
                        <ul class="breadcrumb">
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="{{ route('report.receivables') }}" class="btn btn-sm btn-danger " data-bs-toggle="tooltip" title="{{ __('Reset') }}" data-original-title="{{ __('Reset') }}">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($resultArray as $receivableCustomer)
                                                <tr>
                                                    ...
                                                    <td> {{ !empty($receivableCustomer['credit_price']) ? \App\Models\Utility::priceFormat($receivableCustomer['credit_price']) : \App\Models\Utility::priceFormat(0) }}
                                                    </td>
                                    ...
                                    <table class="table table-flush datatable" id="report-dataTable">
                                        ...
                                        <tbody>
                                            @php
                                                ...
                                                usort($receivableSummaries, function($a, $b) { return strtotime($b['issue_date']) - strtotime($a['issue_date']); });
                                            ...
                                            @foreach ($receivableSummaries as $receivableSummary)
                                                <tr>
                                                    ...
                                                    @if ($receivableSummary['invoice'])
                                                        <td> {{ \App\Models\Utility::invoiceNumberFormat($receivableSummary['invoice']) }}
                                                        @else
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($receivableDetails as $receivableDetail)
                                                <tr>
                                                    ...
                                                    @if ($receivableDetail['invoice'])
                                                        <td> {{ \App\Models\Utility::invoiceNumberFormat($receivableDetail['invoice']) }}
                                                        </td>
                                                    @else
                                                        <td>{{ __('Credit Note') }}</td>
                                                    @endif
                                    ...
                                    <table class="table table-flush datatable" id="report-dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($agingSummaries as $key => $agingSummary)
                                                <tr>
                                                    <td> {{ $key }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($agingSummary['current']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($agingSummary['1_15_days']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($agingSummary['16_30_days']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($agingSummary['31_45_days']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($agingSummary['greater_than_45_days']) }}
                                                    </td>
                                                    <td>{{ \App\Models\Utility::priceFormat($agingSummary['total_due']) }}</td>
                                                </tr>
                                            ...
                                            @if ($agingSummaries != [])
                                                <tr>
                                                    <th>{{ __('Total') }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($currentTotal) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days15) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days30) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days45) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($daysMore45) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($total) }}</th>
                                                </tr>
                                            @endif
                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($moreThan45 as $value)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ \App\Models\Utility::invoiceNumberFormat($value['invoice_id']) }}
                                                    </td>
                                                    <td>{{ __('Invoice') }}</td>
                                                    <td>
                                                        @if ($value['status'] == 0)
                                                    ...
                                                    <td>{{ \App\Models\Utility::priceFormat($value['total_price']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($value['balance_due']) }}</td>
                                                </tr>
                                            @endforeach
                                            @if ($moreThan45 != [])
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th>{{ \App\Models\Utility::priceFormat($daysMore45Total) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($daysMore45Due) }}</th>
                                                </tr>
                                            @endif
                                            ...
                                            @foreach ($days31to45 as $day31to45)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ \App\Models\Utility::invoiceNumberFormat($day31to45['invoice_id']) }}
                                                    </td>
                                                    <td>{{ __('Invoice') }}</td>
                                                    <td>
                                                    ...
                                                    <td>{{ \App\Models\Utility::priceFormat($day31to45['total_price']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($day31to45['balance_due']) }}</td>
                                                </tr>
                                            @endforeach
                                            @if ($days31to45 != [])
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days45Total) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days45Due) }}</th>
                                                </tr>
                                            @endif
                                            ...
                                            @foreach ($days16to30 as $day16to30)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ \App\Models\Utility::invoiceNumberFormat($day16to30['invoice_id']) }}
                                                    </td>
                                                    <td>{{ __('Invoice') }}</td>
                                                    <td>
                                                    ...
                                                    <td>{{ \App\Models\Utility::priceFormat($day16to30['total_price']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($day16to30['balance_due']) }}</td>
                                                </tr>
                                            @endforeach
                                            @if ($days16to30 != [])
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days30Total) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days30Due) }}</th>
                                                </tr>
                                            @endif
                                            ...
                                            @foreach ($days1to15 as $day1to15)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ \App\Models\Utility::invoiceNumberFormat($day1to15['invoice_id']) }}
                                                    </td>
                                                    <td>{{ __('Invoice') }}</td>
                                                    <td>
                                                    ...
                                                    <td>{{ \App\Models\Utility::priceFormat($day1to15['total_price']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($day1to15['balance_due']) }}</td>
                                                </tr>
                                            @endforeach
                                            @if ($days1to15 != [])
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days15Total) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($days15Due) }}</th>
                                                </tr>
                                            @endif
                                            ...
                                            @foreach ($currents as $current)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ \App\Models\Utility::invoiceNumberFormat($current['invoice_id']) }}
                                                    </td>
                                                    <td>{{ __('Invoice') }}</td>
                                                    <td>
                                                        @if ($current['status'] == 0)
                                                    ...
                                                    <td>{{ $current['name'] }}</td>
                                                    <td> - </td>
                                                    <td>{{ \App\Models\Utility::priceFormat($current['total_price']) }}</td>
                                                    <td>{{ \App\Models\Utility::priceFormat($current['balance_due']) }}</td>
                                                </tr>
                                            @endforeach
                                            @if ($currents != [])
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th>{{ \App\Models\Utility::priceFormat($currentTotal) }}</th>
                                                    <th>{{ \App\Models\Utility::priceFormat($currentDue) }}</th>
                                                </tr>
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                <th></th>
                                                <th></th>
                                                <th>{{ \App\Models\Utility::priceFormat($currentTotal + $days15Total + $days30Total + $days45Total + $daysMore45Total) }}
                                                </th>
                                                <th>{{ \App\Models\Utility::priceFormat($currentDue + $days15Due + $days30Due + $days45Due + $daysMore45Due) }}
                                                </th>
                                            </tr>
                                            @endif
                                        </tbody>
