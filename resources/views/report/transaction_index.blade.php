            ...
            @foreach($accounts as $account)
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="card p-4 mb-4">
                        ...
                        @endif
                        <h7 class="text-sm mb-0">{{\App\Models\Utility::priceFormat($account->total)}}</h7>
                    </div>
                </div>
            @endforeach
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            @foreach ($transactions as $transaction)
                                <tr>
                                    <td>{{ \App\Models\Utility::dateFormat($transaction->date)}}</td>
                                    <td>
                                    ...
                                    <td>{{\App\Models\Utility::priceFormat($transaction->amount)}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
