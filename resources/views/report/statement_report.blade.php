    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Account Statement Summary</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Account Statement Summary</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div id="printableArea">
                <div class="row">
                    <div class="col">
                        <input type="hidden" value="{{'Account Statement'.' '.$filter['type'].' '.'Report of'.' '.$filter['startDateRange'].' to '.$filter['endDateRange']}}" id="filename">
                        ...
                        @foreach($reportData['revenueAccounts'] as $account)
                            <div class="col-xl-3 col-md-6 col-lg-3">
                                <div class="card p-4 mb-4">
                                    ...
                                    @endif
                                    <h6 class="report-text mb-0">{{\App\Models\Utility::priceFormat($account->total)}}</h6>
                                </div>
                            </div>
                        @endforeach
                    </div>
                                ...
                                <table class="table datatable">
                                    ...
                                    @if(!empty($reportData['payments']))
                                        @foreach ($reportData['payments'] as $payments)
                                            <tr class="font-style">
                                                <td>{{ \App\Models\Utility::dateFormat($payments->date) }}</td>
                                                <td>{{ \App\Models\Utility::priceFormat($payments->amount) }}</td>
