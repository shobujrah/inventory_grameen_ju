                                            ...
                                            @foreach($revenueIncomeArray as $i=>$revenue)
                                                <tr>
                                                    ...
                                                    @foreach($revenue['amount'] as $j=>$amount)
                                                        <td width="15%">{{\App\Models\Utility::priceFormat($amount)}}</td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
                                        @endif
                                                ...
                                                <table class="table table-flush border">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach($totalIncome as $income)
                                                            <td width="15%">{{\App\Models\Utility::priceFormat($income)}}</td>
                                                        @endforeach
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <table class="table table-flush border" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            @foreach($totalExpense as $expense)
                                                                <td width="15%">{{\App\Models\Utility::priceFormat($expense)}}</td>
                                                            @endforeach
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach($netProfitArray as $i=>$profit)
                                                            <td width="15%"> {{\App\Models\Utility::priceFormat($profit)}}</td>
                                                        @endforeach
                                                    </tr>
                                                </tbody>
                                            </table>
