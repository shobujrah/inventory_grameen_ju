                                        ...
                                        <tbody>
                                            ...
                                            @foreach($incomeArr as $i=>$income)
                                                <tr>
                                                    ...
                                                    @foreach($income['data'] as $j=>$data)
                                                        <td>{{ \App\Models\Utility::priceFormat($data)}}</td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                ...
                                                @foreach($chartIncomeArr as $i=>$income)
                                                    <td>{{ \App\Models\Utility::priceFormat($income)}}</td>
                                                @endforeach
                                            </tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach($chartExpenseArr as $i=>$expense)
                                                        <td>{{\App\Models\Utility::priceFormat($expense)}}</td>
                                                    @endforeach
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    @foreach($netProfitArray as $i=>$profit)
                                                        <td>{{\App\Models\Utility::priceFormat($profit)}}</td>
                                                    @endforeach
                                                </tr>
                                            </tbody>
                                        </table>
