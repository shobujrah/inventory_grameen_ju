                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Bank Balance Transfer</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Bank Balance Transfer</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="#" class="btn btn-primary" data-url="{{ route('bank-transfer.create') }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Bank Account')}}"><i class="fas fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$index+1}}</td>
                                            <td>{{ \App\Models\Utility::dateFormat( $transfer->date) }}</td>
                                            ...
                                            <td>{{  \App\Models\Utility::priceFormat( $transfer->amount)}}</td>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    ...
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['bank-transfer.destroy', $transfer->id],'id'=>'delete-form-'.$transfer->id]) !!}
                                                        <a class="btn btn-sm bg-danger-light" data-bs-toggle="modal" data-bs-target="{{'#deleteModal-'.$transfer->id}}">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                        <div class="modal fade contentmodal" id="{{'deleteModal-'.$transfer->id}}" tabindex="-1" aria-hidden="true">
