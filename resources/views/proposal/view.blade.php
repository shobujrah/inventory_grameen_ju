                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Proposal Detail</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="row timeline-wrapper">
                                <div class="col-md-6 col-lg-4 col-xl-4 d-flex flex-column align-items-center">
                                    ...
                                    <p class="text-muted text-sm mb-3"><i class="far fa-clock mx-1"></i>{{__('Created on ')}}{{\App\Models\Utility::dateFormat($proposal->issue_date)}}</p>
                                    
                                    <a href="{{ route('proposal.edit',\Crypt::encrypt($proposal->id)) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="feather-edit mx-1"></i>{{__('Edit')}}</a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4 d-flex flex-column align-items-center">
                                    ...
                                    <p class="text-muted text-sm mb-3">
                                        @if($proposal->status!=0)
                                            <i class="far fa-clock mx-1"></i>{{__('Sent on')}} {{\App\Models\Utility::dateFormat($proposal->send_date)}}
                                        @else
                                    ...
                                    @if($proposal->status==0)
                                        ...
                                        <a href="{{ route('proposal.sent',$proposal->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" data-original-title="{{__('Mark Sent')}}"><i class="fas fa-paper-plane mx-1"></i>{{__('Send')}}</a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4 d-flex flex-column align-items-center">
                                    ...
                                    <br>
                                    <div class="float-right mt-2 col-md-4 float-end ml-5" data-toggle="tooltip" data-original-title="{{__('Click to change status')}}">
                                        <select class="form-control status_change select2" style="appearance: auto;" name="status" data-url="{{route('proposal.status.change',$proposal->id)}}">
                                ...
                                <div class="invoice-print">
                                    <div class="row invoice-title mt-2">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                            <h4 class="invoice-number">{{ \App\Models\Utility::proposalNumberFormat($proposal->proposal_id) }}</h4>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-end">
                                                <div class="me-4">
                                                    <small>
                                                        ...
                                                        {{\App\Models\Utility::dateFormat($proposal->issue_date)}}<br><br>
                                                    </small>
                                                </div>
                                            ...
                                            <div class="table-responsive mt-2">
                                                <table class="table mb-0 ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>{{\App\Models\Utility::priceFormat($totalDiscount)}}</b>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">{{\App\Models\Utility::priceFormat($proposal->getSubTotal())}}</td>
                                                    </tr>
        
                                                        <tr>
                                                            <td colspan="6"></td>
                                                            <td class="text-end"><b>{{__('Discount')}}</b></td>
                                                            <td class="text-end">{{\App\Models\Utility::priceFormat($proposal->getTotalDiscount())}}</td>
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="blue-text text-end">{{\App\Models\Utility::priceFormat($proposal->getTotal())}}</td>
                                                    </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
