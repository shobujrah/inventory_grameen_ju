                    ...
                    <div class="card repeater">
                        <div class="item-section py-2">
                            <div class="d-flex align-items-center float-end me-2">
                                <a href="#" data-repeater-create="" class="btn btn-primary mb-2 position-relative" style="z-index: 10" data-bs-toggle="modal" data-target="#add-bank">
                                ...
                                <table class="table mb-0" data-repeater-list="items">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-end">Amount<br>
                                            <small class="text-danger font-weight-bold">after tax & discount</small>
                                        </th>
                                        <th></th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="fas fa-trash-alt text-danger" data-repeater-delete></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td class="blue-text border-none"><strong>{{__('Total Amount')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
