                            ...
                            <div class="table-responsive">
                                <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group price-input input-group search-form">
                                                ...
                                                <span class="input-group-text bg-transparent">{{\App\Models\Utility::currencySymbol()}}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group price-input input-group search-form">
                                        ...
                                        <td>
                                            <a href="#" class="fas fa-trash-alt text-danger repeater-action-btn ms-2" data-repeater-delete></a>
                                        </td>
                                    </tr>
                                    <tr>
        
                                        <td  class="form-group">
                                            {{ Form::select('chart_account_id', $chartAccounts,'', array('class' => 'form-control select2 js-searchBox','required'=>'required')) }}
                                        </td>
                                        <td class="form-group">
                                            <div class="input-group ">
                                                {{ Form::text('amount','', array('class' => 'form-control accountAmount','required'=>'required','placeholder'=>__('Amount'))) }}
                                                <span class="input-group-text bg-transparent">{{\App\Models\Utility::currencySymbol()}}</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td><strong>{{__('Sub Total')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td><strong>{{__('Discount')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td></td>
                                        <td><strong>{{__('Tax')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td class="blue-text"><strong>{{__('Total Amount')}} ({{\App\Models\Utility::currencySymbol()}})</strong></td>
