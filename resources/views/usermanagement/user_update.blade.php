        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Edit Verify User</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Users</a></li>
                            <li class="breadcrumb-item active">Edit Verify User</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            {{--
                                            <select class="form-control select2" name="role_name" id="role_name">
                                                <option value="">--Select Role Type--</option>
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->role_type }}" {{ $users->role_name == $role->role_type ? 'selected' : '' }}>{{ $role->role_type }}</option>
                                                @endforeach
                                            </select>
                                            --}}
                                            {{-- <select name="roles[]" id="roles" class="form-control select2" multiple> (-V-) --}}
