                ...
                <div class="card card-table comman-shadow">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-stripped table table-hover table-center mb-0" id="VerifyUsersList">
...
{{-- model verify --}}
<div class="modal custom-modal fade" id="verify" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <div class="form-header">
                    <h3>Verify User</h3>
                    <p>Are you sure want to verify?</p>
                </div>
                <div class="modal-btn verify-action">
                    <div class="row">
                        <form action="{{ route('user/verify') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button type="submit" class="btn btn-primary paid-continue-btn" style="width: 100%;">Verify</button>
                                </div>
                                <div class="col-6">
                                    <a data-bs-dismiss="modal"
                                        class="btn btn-primary paid-cancel-btn">Cancel
...
<script type="text/javascript">
    $(document).ready(function() {
       $('#VerifyUsersList').DataTable({
            processing: true,
            serverSide: true,
            ordering: true,
            searching: true,
            ajax: {
                url:"{{ route('get-unverified-users-data') }}",
            },
            columns: [
                {
                    data: 'user_id',
