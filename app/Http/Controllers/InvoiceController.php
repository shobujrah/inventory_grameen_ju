...
class InvoiceController extends Controller
{
    ...
    public function create($customerId)
    {
            ...
            $invoice_number =Utility::invoiceNumberFormat($this->invoiceNumber());
    ...
    public function store(Request $request)
    {
            ...
            $description=$invoiceProduct->quantity.'  '.__(' quantity sold in invoice').' '.Utility::invoiceNumberFormat($invoice->invoice_id);
    ...
    public function edit($ids)
    {
            ...
            $invoice_number =Utility::invoiceNumberFormat($invoice->invoice_id);
    ...
    public function update(Request $request, Invoice $invoice)
    {
        ...
        for ($i = 0; $i < count($products); $i++) {
            ...
            $type_id = $invoice->id;
            StockReport::where('type','=','invoice')->where('type_id' ,'=', $invoice->id)->delete();
            $description=$products[$i]['quantity'].'  '.__(' quantity sold in invoice').' '.Utility::invoiceNumberFormat($invoice->invoice_id);
    ...
    public function productDestroy(Request $request)
    {
            ...
            Toastr::success('Invoice product successfully deleted.','Success');
    ...
    public function sent($id)
    {
            ...
            Toastr::success('Invoice successfully sent.','Success');
            return redirect()->back();
    ...
    public function createPayment(Request $request, $invoice_id)
    {
            ...
            $payment->invoice   = 'invoice ' .Utility::invoiceNumberFormat($invoice->invoice_id);
            $payment->dueAmount = \App\Models\Utility::priceFormat($invoice->getDue());
    ...
    public function paymentReminder($invoice_id)
    {
        ...
        $invoice->date      = Utility::dateFormat($invoice->send_date);
        $invoice->invoice   =Utility::invoiceNumberFormat($invoice->invoice_id);
        ...
        Toastr::success('Payment reminder successfully send.','Success');
        return redirect()->back();
    }
    ...
    public function duplicate($invoice_id)
    {
            ...
            Toastr::success('Invoice duplicated successfully.','Success');
            return redirect()->back();
