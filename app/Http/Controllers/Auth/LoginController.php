    ...
    public function authenticate(Request $request)
    {
        ...
        try {
            ...
            if (Auth::attempt(['email'=>$email,'password'=>$password])) {
                /** get session */
                $user = Auth::User();
                # checking if the user is verified |V|
                if( $user->is_verified == $is_verified || $user->status == 'Disable' || $user->status == 'Inactive' ) {
                    Toastr::error('Fail, AUTHENTICATION FAILED ','Error');
