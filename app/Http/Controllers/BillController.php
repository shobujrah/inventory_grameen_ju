...
class BillController extends Controller
{
    ...
    public function create($vendorId)
    {
            ...
            $bill_number = Utility::billNumberFormat($this->billNumber());
            $venders     = Vender::pluck('name', 'id');
    ...
    public function store(Request $request)
    {
            ...
            for($i = 0; $i < count($products); $i++)
            {
                ...
                if(!empty($products[$i]['item']))
                {
                    $type='bill';
                    $type_id = $bill->id;
                    $description=$products[$i]['quantity'].'  '.__('quantity purchase in bill').' '. Utility::billNumberFormat($bill->bill_id);
            ...
            Toastr::success('Bill successfully created.','Success');
    ...
    public function show($ids)
    {
            try {
                ...
                Toastr::error('Bill Not Found.','Error');
    ...
    public function edit($ids)
    {
            ...
            if(!empty($bill))
            {
                $category     = ProductServiceCategory::whereNotIn('type', ['product & service', 'income',])
                    ->get()->pluck('name', 'id');
                $category->prepend('Select Category', '');
                $bill_number      = Utility::billNumberFormat($bill->bill_id);
    ...
    public function update(Request $request, Bill $bill)
    {
                ...
                Toastr::success('Bill successfully updated.','Success');
    ...
    public function destroy(Bill $bill)
    {
        ...
        Toastr::success('Bill successfully deleted.','Success');
        return redirect()->route('bill.index');
    ...
    public function productDestroy(Request $request)
    {
            ...
            Toastr::success('Bill product successfully deleted.','Success');
            return redirect()->back();
    ...
    public function sent($id)
    {
            ...
            $bill->bill = Utility::billNumberFormat($bill->bill_id);
            ...
            Toastr::success('Bill successfully sent.','Success');
            return redirect()->back();
    ...
    public function createPayment(Request $request, $bill_id)
    {
            ...
            $payment->bill   = 'bill ' . Utility::billNumberFormat($billPayment->bill_id);
...
//            Mail::to($email)->send(new VenderBillSend($bill));
    ...
    public function duplicate($bill_id)
    {
            ...
            Toastr::success('Bill duplicated successfully.','Success');
            return redirect()->back();
    ...
    public function previewBill($template, $color)
    {
        ...
        return view('bill.templates.' . $template, compact('bill', 'preview', 'color', 'img', 'vendor', 'font_color', 'customFields'));
    }
    ...
    public function saveBillTemplateSettings(Request $request)
    {
        ...
        Toastr::success('Bill Setting updated successfully','Success');
        return redirect()->back();
    }
