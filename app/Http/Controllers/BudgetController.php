...
class BudgetController extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            Toastr::success('Budget Plan successfully created.','Success');
    ...
    public function show($ids)
    {
            try {
                ...
                Toastr::error('Budget Not Found.','Error');
            ...
            foreach($incomeproduct as $cat)
            {
                ...
                if($budget->period == 'monthly')
                {
                    ...
                    for($i = 1; $i <= 12; $i++)
                    {
                        ...
                        $revenuTotalAmount = Revenue::query();
            ...
            foreach($expenseproduct as $expense)
            {
                if($budget->period == 'monthly')
                {
                    ...
                    for($i = 1; $i <= 12; $i++)
                    {
                        ...
                        $paymentTotalAmount = Payment::query();
    ...
    public function update(Request $request, Budget $budget)
    {
        ...
        Toastr::success('Budget Plan successfully updated.','Success');
        return redirect()->route('budget.index');
    ...
    {
        $budget->delete();
        Toastr::success('Budget Plan successfully deleted.','Success');
        return redirect()->route('budget.index');
    }
